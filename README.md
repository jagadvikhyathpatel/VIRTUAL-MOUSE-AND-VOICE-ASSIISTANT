# VIRTUAL-MOUSE-AND-VOICE-ASSIISTANT;[![](https://img.shields.io/badge/python-3.8.5-blue.svg)](https://www.python.org/downloads/) [![platform](https://img.shields.io/badge/platform-windows-green.svg)](https://github.com/xenon-19/Gesture_Controller) 
...
# Getting Started
  ...
  ### Procedure
  ```bash
  git clone https://github.com/jagadvikhyathpatel/VIRTUAL-MOUSE-AND-VOICE-ASSIISTANT.git
  ```
